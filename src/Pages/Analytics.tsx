    ...
    <div className='p-8'>
        ...
        <div className='w-[60%] py-8'>
            ...
            <div className="flex justify-between">
                <div>
                    <div className='flex gap-2 items-center text-[#626262]'><span><AiOutlineComment/> </span> 200 </div>
                </div>
                <div className="h-3"></div>
                <div>
                    <div className='flex gap-2 items-center text-[#626262]'><span><AiOutlineHeart/> </span> 120 </div>
                </div>
                <div className="h-3"></div>
                <div>
                    <div className='flex gap-2 items-center text-[#626262]'><span><MdOutlineAnalytics/> </span> 2190 views </div>
                </div>
            </div>
            <br/>
        ...
        <div className="w-full md:w-1/2 ">
            <div className="flex justify-between">
                <div className="text-center">
                  <p className="font-bold text-[#626262]">Posts</p>
                  <h5>3</h5>
                </div>
                <div className="text-center">
                  <p className="font-bold text-[#626262]">Posts Impressions</p>
                  <h5>2.98k Views</h5>
                </div>
            </div>
            <br />
            <div className="flex justify-between">
                <div className="text-center">
                  <p className="font-bold text-[#626262]">Profile visits</p>
                  <h5 className='text-[#000]'>300</h5>
                </div>

                <div className="text-center">
                  <p className="font-bold text-[#626262]">New Followers</p>
                  <h5 className='text-[#000]'>300</h5>
                </div>
            </div>
        </div>
